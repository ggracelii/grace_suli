...
# Usage: ./trace_comp_rccl_multi.sh
...
run_composition () {
    ...
    echo -e "\n\nRunning Composition $comp (${label})..." >> rccl_multi_output.log
...
run_dc_none () {
    ...
    echo "Running Device Collectives None..." > rccl_multi_output.log
...
sed -i '/^\([0-9]\|#\)/d' rccl_multi_output.log
