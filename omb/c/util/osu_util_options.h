...
#define OMBOP_LONG_OPTIONS_ALL                                                 \
    {                                                                          \
        {"help", no_argument, 0, 'h'}, {"version", no_argument, 0, 'v'},       \
            ...
            {"selective_tuning", no_argument, 0, 'E'},                         \
...
#define OMBOP__COLLECTIVE__ALL_REDUCE        "+:hvfm:i:x:a:c::u:G:P:T:Ilz::ES:"
#define OMBOP__ACCEL__COLLECTIVE__ALL_REDUCE "+:d:hvfm:i:x:a:c::u:G:T:Ilz::ES:"
...
#define OMBOP__COLLECTIVE__NBC_ALL_REDUCE   "+:hvfm:i:x:t:a:c::u:G:P:T:Ilz::ES:"
#define OMBOP__ACCEL__COLLECTIVE__NBC_ALL_REDUCE                               \
    "+:d:hvfm:i:x:t:a:c::u:G:T:Ilz::ES:"
...
#define OMBOP__COLLECTIVE__ALL_REDUCE_P        "+:hvfm:i:x:a:c::u:G:P:T:Ilz::ES:"
#define OMBOP__ACCEL__COLLECTIVE__ALL_REDUCE_P "+:d:hvfm:i:x:a:c::u:G:T:Ilz::ES:"
...
#define OMBOP_HELP_MSG                                                         \
    {                                                                          \
        {'h', "print this help"}, {'v', "print version info"},                 \
            ...
            {'E', "Enable selective tuning mode. Uses CPU buffers for "        \
                  "message sizes less than the threshold, and ROCM "           \
                  "accelerator buffers for sizes greater than the threshold."  \
                  "Must be configured with ROCM support."},                    \
            {'S', "SIZE - Set the threshold size (in bytes) for switching "    \
                  "from CPU to ROCM  buffers in selective tuning mode."},      \
